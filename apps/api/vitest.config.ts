...
export default defineConfig({
  test: {
    ...
    coverage: {
       ...
       */
      thresholds: {
        'src/lib/**':        { lines: 79, statements: 76, functions: 77, branches: 67 },  // 81.0/78.8/79.9/70.0
        'src/graphql/**':    { lines: 52, statements: 50, functions: 44, branches: 46 },  // 54.0/52.3/46.4/48.3
