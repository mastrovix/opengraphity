  ...
  },
  {
    ...
    fields: [
      { name: 'membershipType',      label: 'Membership Type',        field_type: 'enum',   order: 10,
        enum_values: ['manual', 'dynamic'], default_value: 'manual',
        default_script: `return 'manual'` },
      // Criteria only apply to dynamic membership — hidden for manual groups.
      { name: 'criteriaCiTypes',     label: 'Criteria: CI Types',     field_type: 'string', order: 11,
        visibility_script: `return input.membershipType === 'dynamic'` },
