...
import { type Props, mapCategory, mapEntry, resolveTemplate, toInt } from './helpers.js'

// ── Category mutations ───────────────────────────────────────────────────────

export async function createChangeCatalogCategory(
  _: unknown,
...
export async function updateChangeCatalogCategory(
  _: unknown,
...
export async function deleteChangeCatalogCategory(_: unknown, args: { id: string }, ctx: GraphQLContext) {
  const session = getSession(undefined, 'WRITE')
  try {
...
export async function reorderChangeCatalogCategories(
  _: unknown,
...
export async function createStandardChangeCatalogEntry(
  _: unknown,
  args: {
...
export async function updateStandardChangeCatalogEntry(
  _: unknown,
  args: {
...
export async function deleteStandardChangeCatalogEntry(_: unknown, args: { id: string }, ctx: GraphQLContext) {
  const session = getSession(undefined, 'WRITE')
  try {
    await runQuery(session, `
      MATCH (e:StandardChangeCatalogEntry {id: $id, tenant_id: $tenantId})
...
export async function createChangeFromCatalog(
  _: unknown,
