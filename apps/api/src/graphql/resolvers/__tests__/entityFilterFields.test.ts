...
describe('entityFilterFields (sostituto dell\'introspezione per il FilterBuilder)', () => {
  it('Incident: scalari ed enum inclusi, liste e oggetti esclusi', () => {
    ...
    expect(byName.get('title')).toEqual({ name: 'title', kind: 'SCALAR', scalarName: 'String', enumValues: null, label: null, choices: [], formFieldType: null, vocabulary: null, rowFilter: false, settableByAutomation: false, multi: false })
