...
function mapRule(props: Record<string, unknown>) {
  ...
  return {
    ...
    escalationDelayMinutes:    (props['escalation_delay_minutes']     ?? null) as number | null,
    ...
    slaWarningThresholdPercent:(props['sla_warning_threshold_percent'] ?? null) as number | null,
