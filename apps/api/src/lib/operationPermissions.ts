...
const RULES: ReadonlyArray<{ anyOf: OperationRequirement; query?: readonly string[]; mutation?: readonly string[] }> = [
  ...
  // (team, persone, tipi, vocabolari, workflow, calendari).
  {
    ...
    query: [
      ...
      'ciTypes', 'baseCIType', 'itilTypes', 'itilTypeFields', 'itilCIRelationRules', 'allITILCIRelationRules',
  ...
  { anyOf: ['request.read'], query: ['serviceRequests', 'serviceRequest'] },
  ...
  },
  {
    ...
    mutation: [
      ...
      'updateITILType', 'createITILField', 'updateITILField', 'deleteITILField', 'createITILCIRelationRule', 'deleteITILCIRelationRule',
