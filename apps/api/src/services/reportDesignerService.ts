...
4bis. Ogni grafico raggruppato per una DATA ha un periodo ("raggruppa_per_periodo"), serie e istogrammi allo stesso modo: giorni per una settimana o due, settimane per qualche mese, mesi per un anno o più. «gli incident degli ultimi 6 mesi» raggruppati vuol dire per MESE: per giorno sarebbero 180 punti illeggibili, e a barre 180 barre alte 1.
