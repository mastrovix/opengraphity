...
export const GET_AI_SETTINGS = gql`
  query GetAISettings {
    aiSettings {
      features { triage assistant reportAnalysis postIncident kbArticles embeddings formDesigner reportDesigner platformSelfAnalysis dailyWorkAnalysis configurationAssist }
