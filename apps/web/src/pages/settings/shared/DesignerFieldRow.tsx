  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 6 }}>
        ...
        {editText !== '' && <Button variant="secondary" onClick={onEdit}>{editText}</Button>}
        {!field.isSystem && (
          <Button variant="danger" size="xs" onClick={onDelete} aria-label={t('designerFieldRow.deleteField', { name: field.name })}>
            <Trash2 size={12} />
          </Button>
        )}
      </div>
