...
const render = (incident: ServiceOpenIncident | null, openIncidentFrom = 'down') =>
  renderWithProviders(<ServiceOpenIncidentCard incident={incident} openIncidentFrom={openIncidentFrom} />)
...
describe('ServiceOpenIncidentCard', () => {
  it('incident aperto: numero come link al ticket, titolo, stato e passo del workflow', () => {
    render(asIncident())
    ...
    expect(screen.getByText('in progress')).toBeInTheDocument()          // stato, senza underscore
