...
export function ReportDetailView(props: ReportDetailViewProps) {
    ...
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ padding: '12px 32px', borderBottom: '1px solid #e5e7eb', background: '#fff', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
          ...
          <span style={{ fontWeight: 600, fontSize: 15, color: 'var(--color-slate-dark)' }}>Aggiungi sezione &mdash; {selected.name}</span>
        </div>
  ...
  if (view === 'edit-section' && editSection) {
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ padding: '12px 32px', borderBottom: '1px solid #e5e7eb', background: '#fff', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
          <button onClick={cancelEditSection} style={{ ...btnGhost, padding: '6px 12px', fontSize: 12 }}>&larr; Indietro</button>
