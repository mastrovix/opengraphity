        ...
        {change.availableTransitions.map((tr) => {
          ...
          return (
            <button
              ...
              style={{ padding: '8px 16px', backgroundColor: colors.bg, color: colors.color, border: 'none', borderRadius: 7, fontSize: 14, fontWeight: 600, cursor: transitioning ? 'not-allowed' : 'pointer' }}
            >
              {tr.label}
            </button>
          )
