...
const NOTE = new Map([
  ...
  ['apps/web/src/pages/incidents/IncidentDetailPage.tsx#IncidentDetailPage', 143],
  ...
  ['apps/web/src/pages/reports/useCustomReports.ts#useCustomReports', 128],
  ...
  ['apps/web/src/pages/problems/ProblemDetailPage.tsx#ProblemDetailPage', 128],
  ...
  ['apps/api/src/graphql/resolvers/ciTypeMetamodel.ts#buildMetamodelMutations', 146],
  ...
  ['apps/web/src/pages/tasks/TaskViewPage.tsx#TaskViewPage', 105],
  ...
  ['packages/workflow/src/engine.ts#transition', 109],
  ...
  ['apps/web/src/pages/problems/CreateProblemPage.tsx#CreateProblemPage', 68],
  ...
  ['apps/web/src/pages/requests/ServiceRequestDetailPage.tsx#ServiceRequestDetailPage', 67],
  ...
  ['apps/api/src/graphql/resolvers/workflowMutations.ts#executeWorkflowTransition', 74],
